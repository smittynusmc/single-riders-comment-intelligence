...
class CommentClassification(TimestampedModel, Base):
    ...
    override_primary_category: Mapped[PrimaryCategory | None] = mapped_column(Enum(PrimaryCategory))
    override_mvp_area: Mapped[MvpArea | None] = mapped_column(Enum(MvpArea))
